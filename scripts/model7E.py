...
# save loss
with open('trained_models/model7E_opt.txt', 'w') as f:
	f.write("min val loss = %f\t at epoch %i" % (min_val_loss, opt_epoch))
np.savetxt('trained_models/model7E_trainloss.txt', train_loss, fmt='%f')
np.savetxt('trained_models/model7E_valloss.txt', val_loss, fmt='%f')
