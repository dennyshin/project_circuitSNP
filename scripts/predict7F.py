...
# load model
model = torch.load("trained_models/model7F.pt").to(device)
...
plot_PRcurve(recall, precision, 'imgs/model7F_PRcurve.png')
plot_ROCcurve(FPR, recall, 'imgs/model7F_ROCcurve.png')

print("saving metics...")

# save metrics
with open('results/predict7F.txt', 'w') as f:
	f.write("test_loss: %f\n" % test_loss.numpy())
