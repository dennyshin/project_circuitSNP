...
# load model
model = torch.load("trained_models/model6.pt").to(device)
...
plot_PRcurve(recall, precision, 'imgs/model6_PRcurve.png')
plot_ROCcurve(FPR, recall, 'imgs/model6_ROCcurve.png')
