...
# save loss
with open('trained_models/model7C_opt.txt', 'w') as f:
	f.write("min val loss = %f\t at epoch %i" % (min_val_loss, opt_epoch))
np.savetxt('trained_models/model7C_trainloss.txt', train_loss, fmt='%f')
np.savetxt('trained_models/model7C_valloss.txt', val_loss, fmt='%f')
