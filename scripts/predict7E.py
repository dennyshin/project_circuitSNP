...
# load model
model = torch.load("trained_models/model7E.pt").to(device)
...
plot_PRcurve(recall, precision, 'imgs/model7E_PRcurve.png')
plot_ROCcurve(FPR, recall, 'imgs/model7E_ROCcurve.png')

print("saving metics...")

# save metrics
with open('results/predict7E.txt', 'w') as f:
	f.write("test_loss: %f\n" % test_loss.numpy())
